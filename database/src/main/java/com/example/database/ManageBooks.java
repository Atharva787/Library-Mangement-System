...
public class ManageBooks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new Database(ManageBooks.this);
        ...
        customAdapter = new AdapterAdmin(ManageBooks.this, this, book_id, book_title, book_author,
                book_pages);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(ManageBooks.this));
    }
